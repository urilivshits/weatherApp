...
const GeneralBtnSVG = ({wrapper}) => {
    return (
        <svg style={wrapper ? {transform: "rotate(90deg)", left: "80px"} : null} className="generalBtnSVG" width="4" height="7" viewBox="0 0 4 7" fill="none" xmlns="http://www.w3.org/2000/svg">

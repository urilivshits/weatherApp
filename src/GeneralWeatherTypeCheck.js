...
const GeneralWeatherTypeCheck = ({weatherType, wrapper}) => {

    const transitionCheckClear = (time) => {
        return wrapper ? {transition: `all ${time}`, width: "23.42px", height: "24px", left: "-30px", top: "134px"} : 
        {transition: `all ${time}`, width: "27.42px", height: "28px", left: "-36px", top: "154px"}
    };

    const transitionCheckElse = (time) => {
        return wrapper ? {transition: `all ${time}`, width: "29.49px", height: "28.5px", left: "-30px", top: "138px"} : 
        {transition: `all ${time}`, width: "35.49px", height: "34.5px", left: "-37px", top: "150px"}
    };

    if (weatherType === "Clear" || weatherType === "Clouds") {
        return (
            <svg style={transitionCheckClear("300ms")} className="generalIconClear" width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        return (
            <svg style={transitionCheckElse("300ms")} className="generalIconElse" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default GeneralWeatherTypeCheck;